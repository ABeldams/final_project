  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash.php?q=1">Applicant</a></li>
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dash.php?q=2">Result</a></li>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Institution</b></td><td><b>Score</b></td></tr>';
$c=0;
...
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Adress</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td><b>Passport</b></td><td><b>Documents</b></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$college.'</td><td>'.$email.'</td><td>'.$mob.'</td><td><img src='.$image.' width=60px height=60px></td>
	
	<td>
					<button class="alert-success"><a href="download.php?filename='.$cv_name.'&f='.$row["cv"].'">Download</a></button>
				</td>
	
	
	<td><a title="Delete User" href="update.php?demail='.$email.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td>
	
	<td><a href=edit.php?source=edit_staff&u_id='.$email.' class="btn btn-info btn-sm"><span class="fa fa-user"></span>Edit</a></td>
	</tr>';
}
$c=0;
echo '</table></div>';
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'1" name="'.$i.'1" placeholder="Enter option a" class="form-control input-md" type="text" maxlength="50" size="50">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'2" name="'.$i.'2" placeholder="Enter option b" class="form-control input-md" type="text" maxlength="50" size="50">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'3" name="'.$i.'3" placeholder="Enter option c" class="form-control input-md" type="text" maxlength="50" size="50">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="'.$i.'4" name="'.$i.'4" placeholder="Enter option d" class="form-control input-md" type="text" maxlength="50" size="50">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://www.facebook.com/vinit.shahdeo" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook"><i class="fa fa-user"></i></a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1"><i class="fa fa-phone"></i></h4>
		<h4 style="font-family:'typo' "><i class="fa fa-envelope"></i></h4>
		<h4 style="font-family:'typo' "><i class="fa fa-map-marker"></i></h4>
