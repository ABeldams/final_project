...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2023 at 07:47 PM
...
INSERT INTO `user` (`name`, `gender`, `position`, `college`, `email`, `mob`, `cv_name`, `cv`, `passport`, `password`) VALUES
('.gdn.,. ', 'M', 'Graduate Trainee', 'dfln ', 'a10@gmail.com', 123445678, 'upload/CHAPTER TWO.docx', 'CHAPTER TWO.docx', 'upload/appendix1.PNG', 'e10adc3949ba59abbe56e057f20f883e'),
