...
<div class="row">
<div class="col-lg-6">
<span class="logo">YMFB Recruitments</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>YMFB</b></a>
    </div>
...
echo '<div class="panel" style="margin:5%" id="content" onclick="setTimeout(off,5000);">';
...
echo'<button id = "prev" onclick="history.back()" > Previous </button>
   <button id = "next" onclick="history.forward()" > Next </button>';
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="col-md-4">
     ...
     <div class="col-md-5">
    <a href="https://www.facebook.com/vinitshahdeo" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook"><i class="fa fa-user"></i></a>
    ...
    <a href="https://www.github.com/vinitshahdeo" target="_blank"><i style="color:orange; font-size: 24px;" class="fa fa-github"></i></a>
    <a href="https://www.instagram.com/vinitshahdeo" target="_blank"><i style="color:orange; font-size: 24px;" class="fa fa-instagram"></i></a>
    <a href="https://www.twitter.com/Vinit_Shahdeo" target="_blank"><i style="color:orange; font-size: 24px;" class="fa fa-twitter"></i></a>
    <a href="https://www.quora.com/Vinit-Shahdeo-1" target="_blank"><i style="font-size:24px; color:orange;" class="fa fa-quora"></i></a>
    </div></div>
